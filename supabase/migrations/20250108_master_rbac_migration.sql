-- Master RBAC Migration for PakeAja CRM
...
-- 18. Create permission check function
...
-- 19. Update your user to admin (replace with your email)
UPDATE profiles 
SET 
